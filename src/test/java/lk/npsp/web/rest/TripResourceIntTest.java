...
public class TripResourceIntTest {
     ...
     *
     * @see lk.npsp.repository.search.TripSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final TripResource tripResource = new TripResource(tripRepository, mockTripSearchRepository);
